...
import AccessLogModel from "../../../../modules/vendorAdmin/adminAndTools/shared/models/modelAccessLog";
...
const { TABLE_NAME, col } = AccessLogModel;
...
export async function up(knex: Knex): Promise<QueryBuilder> {
  return knex.schema
    ...
    .createTable(TABLE_NAME, (table) => {
      ...
      table.string(col("lastAccessDate", false));
      table.string(col("incorrectTrialCount", false));
      table.string(col("lastPasswordChangeDate", false));
