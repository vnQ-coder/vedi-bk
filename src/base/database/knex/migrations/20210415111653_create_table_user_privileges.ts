...
import UserPrivilegesModel from "../../../../modules/vendorAdmin/adminAndTools/userAdministration/modelUserPrivileges";
import EntityModel from "../../../../modules/shared/models/modelEntity";
import { UserPrivilegesType } from "../../../../modules/vendorAdmin/adminAndTools/shared/types/adminAndToolsTypes";
import { DropTablePostgresql } from "../../../../modules/shared/utils/queriesUtil";

const { TABLE_NAME, col } = UserPrivilegesModel;
...
export async function up(knex: Knex): Promise<QueryBuilder> {
  return knex.schema
    ...
    .createTable(TABLE_NAME, (table) => {
      ...
      table.enu(col("privilege", false), UserPrivilegesType);
