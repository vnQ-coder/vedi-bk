...
import { EntityRolesType, EntityStatusType } from "../../../../modules/shared/types/sharedTypes";
...
const { TABLE_NAME, col } = EntityModel;
...
export async function up(knex: Knex): Promise<QueryBuilder> {
  return knex.schema
    ...
    .createTable(TABLE_NAME, (table) => {
      ...
      table.enu(col("type", false), EntityRolesType);
      table.enu(col("status", false), EntityStatusType);
